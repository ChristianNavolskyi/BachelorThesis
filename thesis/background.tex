...
Their insert workload showed that OrientDB was the slowest among the examined databases across all dataset sizes whereas Redis was the fastest in this category.
