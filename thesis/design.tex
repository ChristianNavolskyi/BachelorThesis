...
The products was made at a specific date and consists of one or multiple components depending on the variable y.
...
Together with the amount of nodes we can calculate the total amount of elements being inserted into the database as shown in equation~\ref{eq:dataElements}.
