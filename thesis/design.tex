...
which has a \texttt{Orders} node that represents the folder for all \texttt{Order}s received by the \texttt{Factory}.
...
as to store an edge two nodes have to be looked up.
