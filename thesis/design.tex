...
An activity diagram is shown in figure~\ref{fig:graphDataRecorder} to illustrate the creation process with usage of the parameters for tweaking the width of the graph.
